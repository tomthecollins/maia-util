...
exports.default = append_ontimes_to_time_signatures;
// Utility.
function append_ontimes_to_time_signatures(time_sigs_array, crotchets_per_bar) {
  ...
  while (i < n) {
    var c = (time_sigs_array[i]["barNo"] - time_sigs_array[i - 1]["barNo"]) * time_sigs_array[i - 1]["topNo"] * 4 / time_sigs_array[i - 1]["bottomNo"];
