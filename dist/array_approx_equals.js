...
exports.default = array_approx_equals;
function array_approx_equals(arr, arr2) {
  var tol = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.00002;
  ...
  for (var i = 0, l = arr.length; i < l; i++) {
    ...
    if (arr[i] instanceof Array && arr2[i] instanceof Array) {
      ...
      if (!array_approx_equals(arr[i], arr2[i])) return false;
