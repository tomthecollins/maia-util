...
exports.default = bar_and_beat_number_of_ontime;
...
function bar_and_beat_number_of_ontime(ontime, time_sigs_array) {
  ...
  var relevant_row = (0, _row_of_max_ontime_leq_ontime_arg2.default)(ontime, time_sigs_array);
  if (ontime >= 0) {
    var excess = ontime - relevant_row["ontime"];
    var local_beat_bar = relevant_row["topNo"] * 4 / relevant_row["bottomNo"];
    var a = [relevant_row["barNo"] + Math.floor(excess / local_beat_bar), excess % local_beat_bar + 1];
  } else {
