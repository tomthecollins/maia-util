var mu = (function () {
   ...
   * [[2, -2]]
   */
  function intersection(arr0, arr1, index = false){
    const ans = [];
    let indices;
  ...
  const sort_points_asc_by_id$1 = sort_points_asc_by_id;
  ...
  const lex_less_or_equal$1 = lex_less_or_equal;
  ...
  var maiaUtil = {
    ...
    sort_points_asc_by_id: sort_points_asc_by_id$1,
    ...
    lex_less_or_equal: lex_less_or_equal$1,
